    ...
    public partial class crearBaseDeDatos : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioProyectos", x => new { x.IdUsuario, x.IdProyecto });
                    table.ForeignKey(
                        name: "FK_UsuarioProyectos_Proyectos_IdProyecto",
                        column: x => x.IdProyecto,
                        principalTable: "Proyectos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioProyectos_Usuarios_IdUsuario",
